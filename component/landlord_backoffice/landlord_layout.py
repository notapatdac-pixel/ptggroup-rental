...
_NAV_ITEMS = [
    ("overview", "grid_view", "Overview", "/landlorddashboard"),
    ("stations", "ev_station", "My Stations", "/landlordstations"),
    ("applications", "assignment", "Applications", "/landlordapplications"),
    ("tenants", "groups", "Tenants", "/landlordtenants"),
    ("revenue", "account_balance_wallet", "Revenue", "/landlordrevenue"),
    ("ai_advisor", "smart_toy", "AI Advisor", "/landlordaiadvisor"),
]
...
def landlord_sidebar(active: str) -> rx.Component:
...
def landlord_layout(active: str, content: rx.Component) -> rx.Component:
    return rx.box(
        nav_bar(),
        landlord_sidebar(active),
        rx.box(
            content,
